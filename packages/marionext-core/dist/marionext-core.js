const _ = (function () {
  ...
  var cloneableTags = {};
  cloneableTags[argsTag] = cloneableTags[arrayTag] = cloneableTags[boolTag] = cloneableTags[dateTag] = cloneableTags[mapTag] =
    cloneableTags[numberTag] = cloneableTags[objectTag] = cloneableTags[regexpTag] = cloneableTags[setTag] = cloneableTags[stringTag] = true;
...
const $dom = (function () {
  ...
  const $dom$1 = $Dom.prototype.init;
  $dom$1.fn = $dom$1.prototype = $Dom.prototype; // Ensuring that `$dom() instanceof $dom`
  $Dom.prototype.length = 0;
  $Dom.prototype.splice = splice; // Ensuring a $dom collection gets printed as array-like in Chrome's devtools
  ...
  $Dom.prototype.map = function (callback) {
    return $dom$1(map.call(this, (ele, i) => callback.call(ele, i, ele)));
  };
  $Dom.prototype.slice = function () {
    return $dom$1(slice.apply(this, arguments));
  };
  ...
  $Dom.prototype.removeProp = function (prop) {
  ...
  $Dom.prototype.extend = function (plugins) {
    /**
     * extend
     * Adds properties to the $Dom collection prototype.
     */
    return extend($dom$1.fn, plugins);
  };
  $dom$1.guid = 1;
  ...
  $dom$1.matches = matches;
  $dom$1.isWindow = isWindow;
  $dom$1.is$Dom = is$Dom;
  $Dom.prototype.prop = function (prop, value) {
    if (!prop) {
      return;
    }
    if (_.isString(prop)) {
  ...
  $Dom.prototype.filter = function (comparator) {
    if (!comparator)
      return $dom$1();
    const compare = getCompareFunction(comparator);
    return $dom$1(filter.call(this, (ele, i) => compare.call(ele, i, ele)));
  };
  ...
  $Dom.prototype.removeAttr = function (attr) {
  ...
  $Dom.prototype.toggleClass = function (cls, force) {
  ...
  $dom$1.unique = unique;
  $Dom.prototype.add = function (selector, context) {
    return $dom$1(unique(this.get().concat($dom$1(selector, context).get())));
  };
  ...
  $dom$1.prefixedProp = getPrefixedProp;
  const numericProps = {
  ...
  function getSuffixedValue(prop, value, isVariable = isCSSVariable(prop)) {
    return !isVariable && !numericProps[prop] && _.isNumber(value) ? `${value}px` : value;
  }
  ...
  each(["width", "height"], (index, prop) => {
    $Dom.prototype[prop] = function (value) {
      if (!this[0])
      ...
      return this.each((i, ele) => {
        ...
        ele.style[prop] = getSuffixedValue(prop, valueNumber.toString() + (boxSizing === "border-box" ? getExtraSpace(ele, !index) : 0));
      });
    };
  });
  each(["Width", "Height"], (index, prop) => {
    $Dom.prototype[`outer${prop}`] = function (includeMargins) {
      if (!this[0])
        return;
      if (isWindow(this[0]))
  ...
  $Dom.prototype.toggle = function (force) {
    return this.each((i, ele) => {
  ...
  const eventsNamespace = "__$domEvents",
  ...
  function addEvent(ele, name, namespaces, selector, callback) {
    callback["guid"] = (callback["guid"] || $dom$1.guid++);
  ...
  $Dom.prototype.off = function (eventFullName, selector, callback) {
  ...
  function on(eventFullName, selector, callback, _one) {
    ...
    each(getSplitValues(eventFullName), (i, eventFullName) => {
      ...
      this.each((i, ele) => {
        ...
        finalCallback.guid = callback["guid"] = (callback["guid"] || $dom$1.guid++); //TSC
  ...
  $Dom.prototype.one = one;
  $Dom.prototype.ready = function (callback) {
    const finalCallback = () => callback($dom);
  ...
  $Dom.prototype.trigger = function (eventFullName, data) {
    let evt;
    if (_.isString(eventFullName)) {
  ...
  function val(value) {
    ...
    return this.each((i, ele) => {
      if (ele.tagName === "SELECT") {
        const eleValue = Array.isArray(value) ? value : (value === null ? [] : [value]);
  ...
  function parseHTML(html) {
    ...
    return $dom$1(container.childNodes).detach().get();
  }
  $dom$1.parseHTML = parseHTML;
  ...
  $Dom.prototype.offsetParent = function () {
    return $dom$1(this[0] && this[0].offsetParent);
  };
  ...
  $Dom.prototype.children = function (comparator) {
    const result = [];
    this.each((i, ele) => {
      push.apply(result, ele.children);
    });
    return filtered($dom$1(unique(result)), comparator);
  };
  $Dom.prototype.contents = function () {
    const result = [];
    this.each((i, ele) => {
      push.apply(result, ele.tagName === "IFRAME" ? [ele["contentDocument"]] : ele.childNodes);
    });
    return $dom$1(unique(result));
  };
  ...
  $Dom.prototype.append = function () {
    each(arguments, (i, selector) => {
      insertContent(this, $dom$1(selector));
    });
    return this;
  };
  $Dom.prototype.appendTo = function (selector) {
    insertContent($dom$1(selector), this);
    return this;
  };
  $Dom.prototype.insertAfter = function (selector) {
    $dom$1(selector).each((index, ele) => {
  ...
  $Dom.prototype.after = function () {
    each(reverse.apply(arguments), (i, selector) => {
      reverse.apply($dom$1(selector).slice()).insertAfter(this);
    });
    return this;
  };
  $Dom.prototype.insertBefore = function (selector) {
    $dom$1(selector).each((index, ele) => {
      const parent = ele.parentNode;
      if (parent) {
        this.each((i, e) => {
  ...
  $Dom.prototype.before = function () {
    each(arguments, (i, selector) => {
      $dom$1(selector).insertBefore(this);
    });
    return this;
  };
  $Dom.prototype.prepend = function () {
    each(arguments, (i, selector) => {
      insertContent(this, $dom$1(selector), true);
    });
    return this;
  };
  $Dom.prototype.prependTo = function (selector) {
    insertContent($dom$1(selector), reverse.apply(this.slice()), true);
    return this;
  };
  $Dom.prototype.replaceWith = function (selector) {
    return this.before(selector).remove();
  };
  $Dom.prototype.replaceAll = function (selector) {
    $dom$1(selector).replaceWith(this);
    return this;
  };
  $Dom.prototype.wrapAll = function (selector) {
    if (this[0]) {
      const structure = $dom$1(selector);
  ...
  $Dom.prototype.wrap = function (selector) {
    return this.each((index, ele) => {
      const wrapper = $dom$1(selector)[0];
      $dom$1(ele).wrapAll(!index ? wrapper : wrapper.cloneNode(true));
    });
  };
  $Dom.prototype.wrapInner = function (selector) {
    return this.each((i, ele) => {
      const $ele = $dom$1(ele),
  ...
  $Dom.prototype.is = function (comparator) {
  ...
  $Dom.prototype.next = function (comparator, _all) {
    return filtered($dom$1(unique(pluck(this, "nextElementSibling", _all))), comparator);
  };
  $Dom.prototype.nextAll = function (comparator) {
    return this.next(comparator, true);
  };
  $Dom.prototype.not = function (comparator) {
    if (!comparator || !this[0])
      return this;
    const compare = getCompareFunction(comparator);
    return this.filter((i, ele) => !compare.call(ele, i, ele));
  };
  $Dom.prototype.parent = function (comparator) {
    return filtered($dom$1(unique(pluck(this, "parentNode"))), comparator);
  };
  $Dom.prototype.index = function (selector) {
    const child = selector ? $dom$1(selector)[0] : this[0],
      collection = selector ? this : $dom$1(child).parent().children();
    return indexOf.call(collection, child);
  };
  $Dom.prototype.closest = function (comparator) {
    if (!comparator || !this[0])
      return $dom$1();
  ...
  $Dom.prototype.parents = function (comparator) {
    return filtered($dom$1(unique(pluck(this, "parentElement", true))), comparator);
  };
  $Dom.prototype.prev = function (comparator, _all) {
    return filtered($dom$1(unique(pluck(this, "previousElementSibling", _all))), comparator);
  };
  $Dom.prototype.prevAll = function (comparator) {
    return this.prev(comparator, true);
  };
  $Dom.prototype.siblings = function (comparator) {
    const result = [];
    this.each((i, ele) => {
      push.apply(result, $dom$1(ele).parent().children((ci, child) => child !== ele));
    });
    return filtered($dom$1(unique(result)), comparator);
  };
  $Dom.prototype.getCssDuration = function (cssProps) {
    var el = this[0],
      durString, isMS, matchDuration, result = 0;
    if (Array.isArray(cssProps)) {
      cssProps.forEach(cssProp => {
        durString = computeStyle(el, cssProp).toLowerCase();
      ...
      durString = computeStyle(el, cssProps).toLowerCase();
      isMS = durString.indexOf("ms") >= 0;
      matchDuration = durString.match(/\d+(\.\d+)?/g);
      if (isMS) {
        result = result + parseInt(matchDuration[0], 10);
  ...
  $Dom.prototype.adjustTextareaHeight = function () {
    var $element = $dom$1(this),
...
const proxy = function proxy(method) {
 ...
 */
const extendModel$1 = function (protoProps) {
  const Parent = this;
  let classProperties = {};
...
function splice$1(array, insert, at) {
...
const makeCollectionIterator$1 = (function () {
...
const extendCollection$1 = function (protoProps) {
  const Parent = this;
  let classProperties = {};
  for (let prop in protoProps) {
    if (typeof protoProps[prop] !== "function") {
...
Collection.extend = extendCollection$1;
...
CollectionProto.findIndex = function (predicate) {
  return this.models.findIndex(makeCollectionIterator$1(predicate, this));
};
CollectionProto.filter = function (predicate) {
  return this.models.filter(makeCollectionIterator$1(predicate, this));
};
CollectionProto.find = function (predicate) {
  return this.models.find(makeCollectionIterator$1(predicate, this));
};
...
CollectionProto.some = function (predicate) {
  return this.models.some(makeCollectionIterator$1(predicate, this));
};
CollectionProto.every = function (predicate) {
  return this.models.every(makeCollectionIterator$1(predicate, this));
};
...
CollectionProto.countBy = function (predicate) {
  return _.countBy(this.models, makeCollectionIterator$1(predicate, this));
};
CollectionProto.groupBy = function (predicate) {
  return _.groupBy(this.models, makeCollectionIterator$1(predicate, this));
};
...
const bindEvents = function (entity, bindings) {
  if (!entity || !bindings) {
    return this;
  }
...
const unbindEvents = function (entity, bindings) {
  if (!entity) {
    return this;
  }
  if (!bindings) {
...
const bindRequests = function bindRequests(channel, bindings) {
  if (!channel || !bindings) {
    return this;
  }
...
const unbindRequests = function unbindRequests(channel, bindings) {
  if (!channel) {
    return this;
  }
  if (!bindings) {
...
Object.assign(BrowserHistory.prototype, Events);
const BrowserHistoryInstance = BrowserHistory.getInstance();

const makeContainerIterator$1 = (function () {
...
const getNamespacedEventName$1 = (function () {
  const delegateEventSplitter = /^(\S+)\s*(.*)$/;
  return function getNamespacedEventName(eventName, namespace) {
    const match = eventName.match(delegateEventSplitter);
    return `${match[1]}.${namespace} ${match[2]}`;
  };
}());
const _invoke$2 = _.invokeMap || _.invoke;
const extendView$1 = function (protoProps) {
  const Parent = this;
  let classProperties = {};
  for (let prop in protoProps) {
    if (typeof protoProps[prop] !== "function") {
...
const extendCollectionView$1 = function (protoProps) {
  const Parent = this;
  let classProperties = {};
  for (let prop in protoProps) {
    if (typeof protoProps[prop] !== "function") {
...
const extendRegion$1 = function (protoProps) {
  const Parent = this;
  let classProperties = {};
  for (let prop in protoProps) {
    if (typeof protoProps[prop] !== "function") {
...
const extendBehavior$1 = function (protoProps) {
  const Parent = this;
  let classProperties = {};
  for (let prop in protoProps) {
    if (typeof protoProps[prop] !== "function") {
...
const extendApplication$1 = function (protoProps) {
  const Parent = this;
  let classProperties = {};
  for (let prop in protoProps) {
    if (typeof protoProps[prop] !== "function") {
...
// interface ExtendedManager extends Manager {}
// type extendManager = <T extends ObjectHash>(protoProps: T) => { new(): T extends ExtendedManager };
const extendManager$1 = function (protoProps) {
  const Parent = this;
  let classProperties = {};
  for (let prop in protoProps) {
    if (typeof protoProps[prop] !== "function") {
...
const extendRouter$1 = function (protoProps) {
  const Parent = this;
  let classProperties = {};
  for (let prop in protoProps) {
    if (typeof protoProps[prop] !== "function") {
...
const Requests = {};
Object.assign(Requests, (function () {
...
Object.assign(Radio, Events, Requests);

const CommonMixin = Object.assign(Events, {
...
Manager.extend = extendManager$1;
// Object Methods
// --------------
...
const BehaviorsMixin = (function () {
  ...
  return {
    ...
    _getBehaviorTriggers() {
      const triggers = _invoke$2(this._behaviors, "_getTriggers");
      return triggers.reduce((memo, _triggers) => {
        return Object.assign(memo, _triggers);
      }, {});
    },
    _getBehaviorEvents() {
      const events = _invoke$2(this._behaviors, "_getEvents");
    ...
    _proxyBehaviorViewProperties() {
      _invoke$2(this._behaviors, "proxyViewProperties");
    },
    // delegate modelEvents and collectionEvents
    _delegateBehaviorEntityEvents() {
      _invoke$2(this._behaviors, "delegateEntityEvents");
    },
    // undelegate modelEvents and collectionEvents
    _undelegateBehaviorEntityEvents() {
      _invoke$2(this._behaviors, "undelegateEntityEvents");
    },
    _destroyBehaviors(options) {
      ...
      _invoke$2(this._behaviors, "destroy", options);
    },
    // Remove a behavior
    ...
    _bindBehaviorUIElements() {
      _invoke$2(this._behaviors, "bindUIElements");
    },
    _unbindBehaviorUIElements() {
      _invoke$2(this._behaviors, "unbindUIElements");
    },
    _triggerEventOnBehaviors(eventName, view, options) {
      _invoke$2(this._behaviors, "triggerMethod", eventName, view, options);
    }
  };
}());
...
const setEnabled = function setEnabled(name, state) {
...
const TriggersMixin = (function () {
  ...
  return {
    ...
    _getViewTriggers(view, triggers) {
      ...
      return triggers.reduce((events, value, key) => {
        key = getNamespacedEventName$1(key, `trig${this.cid}`);
...
// DomApi
const setDomApi = function setDomApi(mixin) {
...
}, ElementMixin, BehaviorsMixin, CommonMixin, DelegateEntityEventsMixin, TemplateRenderMixin, TriggersMixin, UIMixin);

// Static setter for the renderer
const setRenderer = function setRenderer(renderer) {
...
const ViewRegionMixin = {
  ...
  _addRegions(regionsDefinitions) {
    ...
    return _.reduce(regionsDefinitions, (regions, definition, name) => {
...
View.extend = extendView$1;
View.setDomApi = setDomApi;
View.setRenderer = setRenderer;
Object.assign(View.prototype, Events, ViewElementMixin, ViewRenderMixin, ViewRegionMixin, BaseViewMixin);
...
CollectionView.extend = extendCollectionView$1;
CollectionView.setDomApi = setDomApi;
CollectionView.setRenderer = setRenderer;
...
ChildViewContainerProto.find = function (predicate) {
  return this._views.find(makeContainerIterator$1(predicate));
};
ChildViewContainerProto.filter = function (predicate) {
  return this._views.filter(makeContainerIterator$1(predicate));
};
ChildViewContainerProto.every = function (predicate) {
  return this._views.every(makeContainerIterator$1(predicate));
};
ChildViewContainerProto.some = function (predicate) {
  return this._views.some(makeContainerIterator$1(predicate));
};
...
Behavior.extend = extendBehavior$1;
...
BehaviorProto._getEvents = function () {
  ...
  return _.reduce(behaviorEvents, (events, behaviorHandler, key) => {
    ...
    key = getNamespacedEventName$1(key, this.cid);
...
Application.extend = extendApplication$1;
// Application Methods
// --------------
...
Object.assign(CollectionView.prototype, CollectionViewCollectionEventsMixin, CollectionViewChildContainerMixin, CollectionViewEmptyViewMixin, CollectionViewAddChildViewsMixin, CollectionViewRenderChildViewsMixin, CollectionViewDetachChildViewsMixin, CollectionViewRemoveChildViewsMixin, CollectionViewSortMixin, CollectionViewFilterMixin, CollectionViewGetChildViewMixin);
// Utilities
...
export {
  bindEvents$1 as bindEvents, unbindEvents$1 as unbindEvents, bindRequests$1 as bindRequests, unbindRequests$1 as unbindRequests, mergeOptions$1 as mergeOptions, getOption, normalizeMethods$1 as normalizeMethods, triggerMethod$1 as triggerMethod, setDomApi$1 as setDomApi, setRenderer$1 as setRenderer, $dom, _, Model, Collection, Region, View, CollectionView, Manager, Behavior, Application, Radio, Channel, Router, BrowserHistoryInstance as BrowserHistory, isEnabled, setEnabled, monitorViewEvents, DomApi
};